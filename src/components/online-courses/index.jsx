...
const displaySection = (OnlineCourses) => {
  if (
    OnlineCourses &&
    Array.isArray(OnlineCourses) &&
...
const OnlineCourses = ({ OnlineCourses, loading, googleAnalytics }) => {
  const renderSkeleton = () => {
    let array = [];
    for (let index = 0; index < OnlineCourses.length; index++) {
      array.push(
  ...
  const renderOnlineCourses = () => {
    return OnlineCourses.map((item, index) => (
      <a
